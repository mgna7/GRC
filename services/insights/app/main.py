"""
INSIGHTS Service - Insights and reporting service for ComplianceIQ platform
"""
...
# Service metadata
SERVICE_NAME = os.getenv("SERVICE_NAME", "insights-service")
...
app = FastAPI(
    ...
    description="Insights and reporting service for ComplianceIQ platform",
