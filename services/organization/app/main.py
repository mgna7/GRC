"""
ORGANIZATION Service - Organization management service for ComplianceIQ platform
"""
...
# Service metadata
SERVICE_NAME = os.getenv("SERVICE_NAME", "organization-service")
...
app = FastAPI(
    ...
    description="Organization management service for ComplianceIQ platform",
