"""
WIDGET Service - Widget configuration service for ComplianceIQ platform
"""
...
# Service metadata
SERVICE_NAME = os.getenv("SERVICE_NAME", "widget-service")
...
app = FastAPI(
    ...
    description="Widget configuration service for ComplianceIQ platform",
