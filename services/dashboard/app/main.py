"""
DASHBOARD Service - Dashboard aggregation service for ComplianceIQ platform
"""
...
# Service metadata
SERVICE_NAME = os.getenv("SERVICE_NAME", "dashboard-service")
...
app = FastAPI(
    ...
    description="Dashboard aggregation service for ComplianceIQ platform",
